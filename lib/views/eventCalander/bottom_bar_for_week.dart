...
class BottomNavigationForWeek extends StatefulWidget {
  BottomNavigationForWeek({
    Key? key,
  }) : super(key: key);

  @override
  State<BottomNavigationForWeek> createState() =>
      _BottomNavigationForWeekState();
}

class _BottomNavigationForWeekState extends State<BottomNavigationForWeek> {
  int _currentIndex = 3;
  List _screens = [];
