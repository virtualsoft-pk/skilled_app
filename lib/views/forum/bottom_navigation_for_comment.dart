...
class BottomForComment extends StatefulWidget {
  BottomForComment({
    Key? key,
    this.date,
    this.desc1,
  ...
  String? date, desc1, desc2, image, motion, name, ui, web;

  @override
  State<BottomForComment> createState() => _BottomForCommentState();
}

class _BottomForCommentState extends State<BottomForComment> {
  int _currentIndex = 2;
  List _screens = [];
