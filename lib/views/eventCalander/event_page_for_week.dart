...
import 'bottom_bar_for_month.dart';
import 'bottom_bar_for_week.dart';
import 'completed_events_screen.dart';

class EventPageForWeek extends StatefulWidget {
  const EventPageForWeek({Key? key}) : super(key: key);

  @override
  State<EventPageForWeek> createState() => _EventPageForWeekState();
}
            ...
            SliverToBoxAdapter(
              child: Column(
                children: [
                  ...
                  isHideCalader == true ? SizedBox() : weekCalendar(),
                ],
              ),
            ),
            SliverToBoxAdapter(
